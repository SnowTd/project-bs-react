export default function AboutUs () {
    return (
        <>
            <div className="flex mt-48 uppercase justify-center font-Kanit mb-4">
                <div className="font-bold text-4xl text-gray-700">
                    <p>About Us</p>
                </div>
            </div>
            <div className="text-xl md:pl-12 md:pr-12 md:mx-72 text-center rounded-full font-Kanit mb-56">

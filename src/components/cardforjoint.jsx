export default function Jointshop () {
    return (
        <>
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-2xl shadow shadow-2xl">
                <a href="#" className="flex justify-center">
                    <img class="p-8 rounded-t-lg w-56" src="https://img5.pic.in.th/file/secure-sv1/IMG_0626.png" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-white-900">JOINT SADA</h5>
                    </a>
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 dark:text-gray-900">$599</span>

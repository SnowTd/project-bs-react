export default function Foot () {
    ...
    return (
        ...
        <footer class="bg-white dark:bg-gray-100 mt-24 font-Kanit">
                ...
                <div class="grid grid-cols-2 gap-6 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="/product" class="hover:underline">WATCH</a>
                            </li>
                            <li>
                                <a href="/joint" class="hover:underline">JOINT</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                            <a href="https://www.facebook.com/profile.php?id=61556957805772" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <li class="mb-4">
                                <a href="https://www.instagram.com/zemit.official?igsh=MTNvdHAybHA1a253dw==">
                            ...
                            <li>
                                <a href="https://www.tiktok.com/@zemit.official?_t=8kiu0hKyTyM&_r=1">

    ...
    return (
        <div className="">
            <div className="flex md:justify-center justify-center w-auto md:py-12">
                <img className="flex mt-8 hover:translate-y-2 transition duration-500" src="https://media.discordapp.net/attachments/1152548462727020626/1217569497293258902/Asset_3logoall.png?ex=660480f5&is=65f20bf5&hm=e6663d287521eb7f820062799a2843897bfcff9db7c7415ed91ef96fe386f556&=&format=webp&quality=lossless" alt="" />
            </div>

                        ...
                        <div className="p-4 px-20 shadow md:flex md:items-center justify-between ">
                            ...
                            <div className="flex justify-between md:hidden">
                                <div className=" md:px-10 ">
                                    <img src="https://img.freepik.com/free-vector/colorful-letter-gradient-logo-design_474888-2309.jpg?size=338&ext=jpg&ga=GA1.1.735520172.1710288000&semt=ais" alt="" className="w-8 h-8" />
                                </div>
